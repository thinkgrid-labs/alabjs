/**
 * @alab/sync/powersync — PowerSync adapter (Postgres/Supabase → SQLite in browser).
 *
 ...
 * ```tsx
 * // app/layout.tsx
 * import { PowerSyncProvider } from "@alab/sync/powersync";
 ...
 *
 * // app/todos/page.tsx
 * import { usePowerSyncQuery, usePowerSyncMutation } from "@alab/sync/powersync";
 *
...
export function usePowerSync(): PowerSyncInstance {
  ...
  if (!db) throw new Error("[alab/sync] usePowerSync must be used inside <PowerSyncProvider>");
  return db;
}
