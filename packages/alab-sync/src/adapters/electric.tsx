/**
 * @alab/sync/electric — ElectricSQL adapter (Postgres → client shape sync).
 *
 ...
 * ```tsx
 * // app/layout.tsx
 * import { ElectricProvider } from "@alab/sync/electric";
 *
 ...
 *
 * // app/todos/page.tsx
 * import { useShape } from "@alab/sync/electric";
 *
